            ...
            <div className="max-w-md w-full space-y-8 bg-white p-10 rounded-lg shadow-lg">
                ...
                <div className="mt-8 space-y-6">
                    <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                         <button type="button" onClick={() => onNavigate('/signup/researcher')} className="w-full flex flex-col items-center justify-center p-6 border-2 border-gray-300 rounded-md hover:border-blue-500 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition-all">
                            ...
                            <span className="mt-1 text-sm text-gray-500">Find bugs, get paid.</span>
                        </button>
                        
                         <button type="button" onClick={() => onNavigate('/signup/organization')} className="w-full flex flex-col items-center justify-center p-6 border-2 border-gray-300 rounded-md hover:border-blue-500 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition-all">
                            ...
                            <span className="mt-1 text-sm text-gray-500">Secure your assets.</span>
                         </button>
                    </div>
                    <p className="mt-6 text-center text-sm text-gray-600">
                        Already have an account?
                        <a href="/login" onClick={(e) => { e.preventDefault(); onNavigate('/login'); }} className="font-medium text-blue-600 hover:text-blue-500">
                            Log in
                        </a>
                    </p>
                </div>
